...
//////////////////////////////////////////////////////////////
// NOTE: renamed discardCard to discardCard because that's what it is actually for
//////////////////////////////////////////////////////////////
...
int main() {
	...
	for(thisPlayer=0; thisPlayer<numPlayers; thisPlayer++) {
		...
		ret = discardCard(3,thisPlayer,&G,1);
		fail = 0;
		...
		ret = discardCard(1,thisPlayer,&G,0);
		fail = 0;
		// do to testG what the function is supposed to do to G
		...
		ret = discardCard(0,thisPlayer,&G,1);
		fail = 0;
		// do to testG what the function is supposed to do to G
		...
		ret = discardCard(0,thisPlayer,&G,0);
		fail = 0;
		// do to testG what the function is supposed to do to G
