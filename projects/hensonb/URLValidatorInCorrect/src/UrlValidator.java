...
public class UrlValidator implements Serializable {
     ...
     */
    private static final int PARSE_URL_SCHEME = 2;		// anything up to first ? or / or ? or #, ends with :

    /**
     * Includes hostname/ip and port number.
     */
    private static final int PARSE_URL_AUTHORITY = 4;	// starts // then anything up to the first / or ? or #

    private static final int PARSE_URL_PATH = 5;		// anything up to the first ? or #

    private static final int PARSE_URL_QUERY = 7;		// starts ? then anything up to #

    private static final int PARSE_URL_FRAGMENT = 9;	// starts # then anything remaining
    ...
    private static final int PARSE_AUTHORITY_PORT = 2;			// starts : then any number of digits
